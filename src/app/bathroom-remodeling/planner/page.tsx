...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    "Plan your bathroom remodel step by step. Measurements, layout, fixtures, finishes, conditions, estimate, permits, and a contractor-ready brief.",
  path: "/bathroom-remodeling/planner",
  noIndex: true,
});
...
export default function PlannerPage() {
  ...
  return <BathroomPlanner flags={flags} backHref="/bathroom-remodeling" />;
}
