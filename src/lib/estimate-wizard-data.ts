...
export const TRADE_WIZARDS: Record<LandingCategoryId, TradeWizardConfig> = {
  ...
  "design-build": {
    trade: "design-build",
    intro: "Design-build projects combine planning and construction — additions, ADUs, and whole-home work. We'll capture footprint, project type, and how far along your plans are.",
    questions: [
      {
        id: "project_type",
        label: "What kind of design-build project?",
        type: "single",
        required: true,
        options: [
          { value: "addition", label: "Home addition", hint: "New square footage" },
          { value: "adu", label: "ADU / in-law suite" },
          { value: "whole_home", label: "Whole-home renovation" },
          { value: "outdoor_living", label: "Outdoor living design-build" },
        ],
      },
      {
        id: "sqft",
        label: "Approximate square footage in scope",
        type: "number",
        min: 150,
        max: 3000,
        step: 50,
      ...
      {
        id: "design_stage",
        label: "Where are you in the design process?",
        type: "single",
        required: true,
        options: [
          { value: "concept_only", label: "Just an idea — need design help" },
          { value: "have_plans", label: "Have architectural plans" },
          { value: "need_permits", label: "Plans done — need permit-ready drawings" },
        ],
      },
      {
        id: "finish_level",
  ...
  "general-contracting": {
    ...
    intro: "General contracting spans coordinating one trade to running a whole-house renovation. Tell us the scope and how many rooms or areas are involved.",
    questions: [
      {
        id: "scope",
        ...
        required: true,
        options: [
          { value: "single_trade", label: "Coordinate a single trade" },
          { value: "multi_trade", label: "Multiple trades on one project" },
          { value: "full_reno", label: "Whole-house renovation" },
        ],
      },
      {
        id: "rooms_affected",
        label: "How many rooms / areas are in scope?",
        type: "number",
        min: 1,
        max: 12,
        step: 1,
      ...
      {
        id: "budget_known",
        label: "Do you have a target budget?",
        type: "single",
        required: true,
        options: [
          { value: "has_budget", label: "Yes — I have a number in mind" },
          { value: "need_help", label: "No — need help scoping" },
        ],
      },
      {
        id: "finish_level",
  ...
  hardscaping: {
    trade: "hardscaping",
    intro: "Hardscaping cost depends on the type of feature, materials, and square footage. Give us your best estimate — we'll refine with bids.",
    questions: [
      {
        id: "job_type",
        ...
        options: [
          ...
          { value: "fire_pit", label: "Fire pit / seating area" },
          { value: "full_yard", label: "Full outdoor living package" },
        ],
      },
      {
        id: "sqft",
        label: "Approximate area",
        help: "For walls, this is the wall face area. Skip if not applicable.",
        type: "number",
        min: 20,
        max: 2000,
        step: 20,
      ...
      },
      {
        ...
        options: [
          ...
          { value: "gravel", label: "Gravel / loose fill" },
        ],
      },
      {
        id: "quality",
  ...
  masonry: {
    trade: "masonry",
    intro: "Masonry and concrete work ranges from a chimney repair to a new driveway. Tell us the job type and size.",
    questions: [
      {
        id: "job_type",
        label: "What kind of masonry work?",
        type: "single",
        required: true,
        options: [
          { value: "chimney", label: "Chimney repair / rebuild" },
          { value: "foundation_repair", label: "Foundation crack / repair" },
          { value: "brick_repair", label: "Brick / block repair, repointing" },
          { value: "block_wall", label: "New masonry / block wall" },
          { value: "driveway", label: "Concrete driveway" },
          { value: "walkway_steps", label: "Walkway / steps" },
        ],
      },
      {
        id: "sqft",
        label: "Approximate area (driveways, walkways, walls)",
        help: "Skip if not applicable to your job type.",
        type: "number",
        min: 20,
        max: 2000,
        step: 20,
  ...
  remodeling: {
    trade: "remodeling",
    intro: "For remodels spanning multiple rooms, a whole floor, or an addition — not a single kitchen or bath — tell us the scope and square footage.",
    questions: [
      {
        id: "scope",
        label: "What's the scope?",
        ...
        required: true,
        options: [
          { value: "single_room", label: "Single room (not kitchen/bath)" },
      ...
      {
        id: "sqft",
        label: "Approximate square footage remodeled",
        type: "number",
        min: 100,
        max: 5000,
        step: 50,
  ...
  restoration: {
    trade: "restoration",
    intro: "Restoration pricing depends on the damage type, severity, and area affected. An inspection will confirm scope, but this gives you a starting point.",
    questions: [
      {
        id: "damage_type",
        label: "What kind of damage?",
        type: "single",
        required: true,
        options: [
          ...
          { value: "storm", label: "Storm / wind damage" },
        ],
      },
      {
        id: "severity",
        ...
        required: true,
        options: [
          { value: "minor", label: "Minor — contained area" },
          { value: "moderate", label: "Moderate — one room or system" },
          { value: "major", label: "Major — multiple rooms / structural" },
        ],
      },
      {
        id: "sqft",
        label: "Approximate area affected",
        type: "number",
        min: 50,
        max: 5000,
        step: 50,
