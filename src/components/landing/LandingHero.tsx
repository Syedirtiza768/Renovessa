          ...
          {FIRST_JOB_MODE ? (
            <>
              ...
              <p className="mt-5 max-w-[52ch] text-lg text-ink-70">
                Submit your project details and Renovessa will connect you with a qualified contractor — and confirm an actual appointment, not just send your number to five companies.
              </p>
            </>
          ) : (
            <>
