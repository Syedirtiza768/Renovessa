...
export function RockvilleCostGuide() {
  return (
    <section className="px-4 py-12 sm:px-6 bg-bone-1">
      <div className="mx-auto max-w-5xl">
        <h2 className="landing-h2">Rockville bathroom-remodeling cost guide</h2>
        ...
        <Link href="/bathroom-remodeling/rockville-md/cost" className="mt-4 inline-block text-sm font-medium text-accent">
          Full cost guide →
        </Link>
      </div>
    </section>
...
export function RockvillePermitPreview() {
  return (
    <section className="px-4 py-12 sm:px-6">
      <div className="mx-auto max-w-5xl">
        <h2 className="landing-h2">Permit navigator preview</h2>
        <p className="mt-3 max-w-3xl text-ink-70">
          Rockville and Montgomery County permit rules depend on the exact scope. The planner asks a few questions
        ...
        <Link href="/bathroom-remodeling/rockville-md/permits" className="mt-4 inline-block text-sm font-medium text-accent">
          Open the permit navigator →
        </Link>
      </div>
    </section>
  );
...
export function RockvilleMethodology() {
  return (
    <section className="px-4 py-12 sm:px-6">
      <div className="mx-auto max-w-3xl text-sm leading-relaxed text-ink-70">
        ...
        <p className="mt-3">
          The Rockville bathroom estimator uses a deterministic per-square-foot baseline by project objective, multiplied
          by bathroom type, finish tier, and a Rockville location factor. Complexity multipliers add for plumbing
        ...
        <p className="mt-5 text-xs text-ink-40">
          ...
          periodically. Requirements can change; confirm current rules with the City of Rockville, Montgomery County,
          and the Maryland MHIC before construction.
        </p>
      </div>
    </section>
  );
