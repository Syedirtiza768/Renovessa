        ...
        <section className="border-b border-ink-15 bg-bone-1 px-4 py-12 sm:px-6 sm:py-16">
          <div className="mx-auto max-w-5xl">
            ...
            <p className="mt-5 max-w-3xl text-lg leading-relaxed text-ink-70">
              Capture your project scope, explore layout options, and receive a Rockville-local planning range
        ...
        <section className="px-4 py-12 sm:px-6">
          <div className="mx-auto max-w-5xl">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {[
                { t: "Rockville-local planning range", d: "Low/mid/high estimate based on your bathroom size, scope, and Rockville-area costs." },
                ...
                { t: "Permit questions", d: "Guidance on likely permit categories for Rockville and Montgomery County." },
        ...
        <section className="px-4 py-12 sm:px-6 bg-bone-1">
          <div className="mx-auto max-w-5xl">
            ...
            <p className="mt-3 max-w-3xl text-ink-70">
              This is an illustrative example using sample inputs for a Rockville project — not your project.
              Your actual range depends on your bathroom, scope, and selections.
            </p>
            <div className="mt-6 max-w-2xl">
              <div className="landing-card p-6">
                <div className="flex items-center justify-between gap-2 flex-wrap">
                  <p className="text-xs uppercase tracking-wide text-ink-40">Illustrative planning range · Rockville, MD</p>
          ...
          <section className="px-4 py-12 sm:px-6">
            <div className="mx-auto max-w-5xl">
              <div className="landing-card p-6 sm:p-8">
                <h2 className="text-2xl font-semibold text-ink-100">Start your Rockville bathroom plan</h2>
                ...
                <div className="mt-5 grid gap-4 sm:grid-cols-2">
                  <Link href="/bathroom-remodeling/rockville-md/planner?mode=quick" className="landing-card p-5 transition hover:border-ink-40">
                    ...
                    <p className="mt-1 text-sm text-ink-70">Bathroom type, size, finish tier, and a Rockville planning range in minutes.</p>
                  </Link>
