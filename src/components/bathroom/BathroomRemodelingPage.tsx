...
import { BathroomCostGuide, BathroomPermitPreview, BathroomFaq, BathroomMethodology } from "./GenericSections";
import type { BathroomFlags } from "./RockvilleBathroomPage";

export function BathroomRemodelingPage({ flags }: { flags: BathroomFlags }) {
  return (
    <>
      <SiteHeader />
      <main className="landing-page min-h-screen bg-bone-0">
        ...
        <section className="border-b border-ink-15 bg-bone-1 px-4 py-12 sm:px-6 sm:py-16">
          <div className="mx-auto max-w-5xl">
            <p className="landing-eyebrow">Bathroom Remodeling</p>
        ...
        {flags.permitNavigator && <BathroomPermitPreview />}
        ...
        <section className="px-4 py-12 sm:px-6 bg-bone-1">
          <div className="mx-auto max-w-5xl">
            ...
            <p className="mt-3 max-w-3xl text-ink-70">
              Renovessa records license status, insurance status, and the last verification date for each
      ...
      <JsonLd
        data={{
          ...
          "@type": "Service",
          name: "Bathroom remodeling planner",
